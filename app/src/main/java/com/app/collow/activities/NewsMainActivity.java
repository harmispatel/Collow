...
public class NewsMainActivity extends BaseActivity implements SetupViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewByIDs();
        setupEvents();
        BaseTextview baseTextview_news_title=(BaseTextview)findViewById(R.id.textview_news_title);
        baseTextview_news_title.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v1) {
                Intent launchActivity1= new Intent(NewsMainActivity.this,NewsDetail.class);
    ...
    private void findViewByIDs() {
        ...
        newsAdapter.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                ...
                newsbeanArrayList.add(null);
                mRecyclerView.post(new Runnable() {
                    public void run() {
                        newsAdapter.notifyItemInserted(newsbeanArrayList.size() - 1);
                    }
                });
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        newsbeanArrayList.remove(newsbeanArrayList.size() - 1);
                        newsAdapter.notifyItemRemoved(newsbeanArrayList.size());
                        ...
                        for (int i = start + 1; i <= end; i++) {
                            newsbeanArrayList.add(new Newsbean());
    ...
    public void getNewsListing(int startLimit) {
        try {
            ...
            PassParameterbean passParameterbean = new PassParameterbean(this, NewsMainActivity.this, getApplicationContext(), URLs.NEWS, jsonObjectGetPostParameterEachScreen, ScreensEnums.NEWS.getScrenIndex(), NewsMainActivity.class.getClass());
