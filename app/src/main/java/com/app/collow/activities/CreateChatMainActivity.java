...
public class CreateChatMainActivity extends BaseActivity implements SetupViewInterface {
    protected static final int CAMERA_REQUEST = 0;
    protected static final int GALLERY_PICTURE = 1;
    public static BaseTextview baseTextview_property_type = null, baseTextview_property_category = null;
    BaseEdittext edittext_createchat_title = null;
    BaseEdittext edittext_createchat_description = null;
    BaseEdittext edittext_createchat_price = null;
    ...
    RecyclerView recyclerView_grid_chat_images = null;
    ...
    MyButtonView myButtonView_create_chat = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retryParameterbean = new RetryParameterbean(CreateChatMainActivity.this, getApplicationContext(), getIntent().getExtras(), CreateChatMainActivity.class.getClass());
        commonSession = new CommonSession(CreateChatMainActivity.this);
    ...
    public void setupHeaderView() {
        try {
            ...
            baseTextview_header_title.setText(getResources().getString(R.string.create_chat));
    ...
    private void findViewByIDs() {
        try {
            view_home = getLayoutInflater().inflate(R.layout.chat_create_new, null);

            edittext_createchat_title = (BaseEdittext) view_home.findViewById(R.id.edittext_createchat_title);
            edittext_createchat_price = (BaseEdittext) view_home.findViewById(R.id.edittext_createchat_price);
            edittext_createchat_description = (BaseEdittext) view_home.findViewById(R.id.edittext_createchat_description);


            imageView_plus_icon_only = (ImageView) view_home.findViewById(R.id.imageview_upload_image_plus_icon);
            relativeLayout_upload_image_plus_view = (RelativeLayout) view_home.findViewById(R.id.relativelayout_upload_createchat_images);
            frameLayout_container.addView(view_home);


           /* progressBar_property_type = (ProgressBar) view_home.findViewById(R.id.progress_createchat_property_type);
            baseTextview_property_type = (BaseTextview) view_home.findViewById(R.id.communtitytextview_createchat_property_type);
            relativeLayout_property_type = (RelativeLayout) view_home.findViewById(R.id.relativelayout_select_createchat_property_type);*/


            progressBar_property_category = (ProgressBar) view_home.findViewById(R.id.progress_createchat_property_category);
            baseTextview_property_category = (BaseTextview) view_home.findViewById(R.id.communtitytextview_createchat_property_categoty);
            relativeLayout_property_category = (RelativeLayout) view_home.findViewById(R.id.relativelayout_select_createchat_property_category);

            myButtonView_create_chat = (MyButtonView) view_home.findViewById(R.id.mybuttonview_create_chat);
            //  getNewsListing(0);


            recyclerView_grid_chat_images = (RecyclerView) view_home.findViewById(R.id.recycler_view_grid_createchat);
            recyclerView_grid_chat_images.setHasFixedSize(true);
            // Disabled nested scrolling since Parent scrollview will scroll the content.
            recyclerView_grid_chat_images.setNestedScrollingEnabled(false);
            StaggeredGridLayoutManager gaggeredGridLayoutManager = new StaggeredGridLayoutManager(3, 1);
            recyclerView_grid_chat_images.setLayoutManager(gaggeredGridLayoutManager);


            int spanCount = 3; // 3 columns
            int spacing = 15; // 50px
            boolean includeEdge = false;
            recyclerView_grid_chat_images.addItemDecoration(new GridSpacingItemDecoration(spanCount, spacing, includeEdge));


            uploadImageAdapter = new UploadImageAdapter(this);
            recyclerView_grid_chat_images.setAdapter(uploadImageAdapter);
    ...
    private void setupEvents() {
        try {
           /* relativeLayout_property_type.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (stringHashMap_property_types.size() == 0) {
                        ...
                        Intent intent = new Intent(CreateChatMainActivity.this, SelectPropertyTypeOrCategoryActivity.class);
           ...
           /* relativeLayout_property_category.setOnClickListener(new View.OnClickListener() {
            ...
            myButtonView_create_chat.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    try {
                        if (TextUtils.isEmpty(edittext_createchat_title.getText().toString())) {
                            CommonMethods.customToastMessage(getResources().getString(R.string.enter_title), CreateChatMainActivity.this);
                        } else if (!CommonMethods.isMorethenThreeCharacters(edittext_createchat_title.getText().toString())) {
                            CommonMethods.customToastMessage(getResources().getString(R.string.enter_minimum_three_characters), CreateChatMainActivity.this);

                        } else if (TextUtils.isEmpty(edittext_createchat_description.getText().toString())) {
                            CommonMethods.customToastMessage(getResources().getString(R.string.description), CreateChatMainActivity.this);
                        } else if (!CommonMethods.isMorethenThreeCharacters(edittext_createchat_description.getText().toString())) {
                            CommonMethods.customToastMessage(getResources().getString(R.string.enter_minimum_three_characters), CreateChatMainActivity.this);

                        } else if (TextUtils.isEmpty(edittext_createchat_price.getText().toString())) {
                            CommonMethods.customToastMessage(getResources().getString(R.string.enter_price), CreateChatMainActivity.this);
                        } else if (baseTextview_property_type.getText().toString().equals(getResources().getString(R.string.select_propert_type))) {
                            CommonMethods.customToastMessage(getResources().getString(R.string.select_propert_type), CreateChatMainActivity.this);

                        } else if (baseTextview_property_type.getText().toString().equals(getResources().getString(R.string.select_category))) {
                            CommonMethods.customToastMessage(getResources().getString(R.string.select_category), CreateChatMainActivity.this);

                        } else if (bitmapArrayList_uploading.size() == 0) {
                            CommonMethods.customToastMessage(getResources().getString(R.string.upload_images_at_least_one), CreateChatMainActivity.this);

                        } else {

                            requestParametersbean.setTitle(edittext_createchat_description.getText().toString());
                            requestParametersbean.setDescripton(edittext_createchat_description.getText().toString());
                            requestParametersbean.setPrice(edittext_createchat_price.getText().toString());
    ...
    public void createClassiFied() {
        ...
        try {
            JSONObject jsonObjectGetPostParameterEachScreen = GetPostParameterEachScreen.getPostParametersAccordingIndex(ScreensEnums.CREATECHAT.getScrenIndex(), requestParametersbean);

            PassParameterbean passParameterbean = new PassParameterbean(this, CreateChatMainActivity.this, getApplicationContext(), URLs.CREATECHAT, jsonObjectGetPostParameterEachScreen, ScreensEnums.CREATECHAT.getScrenIndex(), CreateChatMainActivity.class.getClass());
                ...
                public void setupUI(Responcebean responcebean) {
                    ...
                    if (responcebean.isServiceSuccess()) {
                        try {
                            ...
                            e.printStackTrace();
                            progressBar_property_type.setVisibility(View.GONE);
                            CommonMethods.customToastMessage(e.getMessage(), CreateChatMainActivity.this);
                    ...
                    if (data != null) {
                        ...
                        try {
                            ...
                            if (bitmap != null) {
                                ...
                                recyclerView_grid_chat_images.setVisibility(View.VISIBLE);
                        ...
                        CommonMethods.customToastMessage(getResources().getString(R.string.cancelled), CreateChatMainActivity.this);
                    }
            ...
            try {
                ...
                if (CommonMethods.checkSuccessResponceFromServer(jsonObject_main)) {
                    ...
                    if (responcebean.getErrorMessage() == null) {
                        CommonMethods.customToastMessage(getResources().getString(R.string.create_chat_done), CreateChatMainActivity.this);

                    } else {
                        CommonMethods.customToastMessage(responcebean.getErrorMessage(), CreateChatMainActivity.this);
                    ...
                    {
                        chatbean.setChat_id(json_single_classified.getString(JSONCommonKeywords.id));
                    }
                    ...
                    {
                        chatbean.setChat_title(json_single_classified.getString(JSONCommonKeywords.PropertyTitle));
                    }
                    ...
                    {
                        chatbean.setChat_description(json_single_classified.getString(JSONCommonKeywords.Description));
                    }

                    if (CommonMethods.handleKeyInJSON(json_single_classified, JSONCommonKeywords.Price))

                    {
                        chatbean.setChat_price(json_single_classified.getString(JSONCommonKeywords.Price));
                    }
                    if (CommonMethods.handleKeyInJSON(json_single_classified, JSONCommonKeywords.Status))

                    {
                        chatbean.setStatus(json_single_classified.getString(JSONCommonKeywords.Status));
                    }
                    if (CommonMethods.handleKeyInJSON(json_single_classified, JSONCommonKeywords.PostedDate))

                    {
                        chatbean.setChat_time(json_single_classified.getString(JSONCommonKeywords.PostedDate));
                    }
                    if (CommonMethods.handleKeyInJSON(json_single_classified, JSONCommonKeywords.OwnerId))

                    {
                        chatbean.setOwnerId(json_single_classified.getString(JSONCommonKeywords.OwnerId));
                    }
...

                    {
                        ...
                        if (CommonMethods.checkJSONArrayHasData(json_single_classified, JSONCommonKeywords.Image)) {
                            ...
                            chatbean.setStringArrayList_images(images_of_classified);

                        }


                        if ((ChatMainActivity.chatbeanArrayList != null)) {
                            ChatMainActivity.chatbeanArrayList.add(0,chatbean);
                            ChatMainActivity.chatAdapter.notifyItemInserted(0);
                            ChatMainActivity.mRecyclerView.smoothScrollToPosition(0);
                            finish();
                    ...
                    if (responcebean.getErrorMessage() == null) {
                        CommonMethods.customToastMessage(getResources().getString(R.string.create_chat_failed), CreateChatMainActivity.this);
                    } else {
                        CommonMethods.customToastMessage(responcebean.getErrorMessage(), CreateChatMainActivity.this);
                ...
                holder.imageview_delete_icon.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (bitmapArrayList_uploading.size() == 0) {
                            recyclerView_grid_chat_images.setVisibility(View.GONE);
                            relativeLayout_upload_image_plus_view.setVisibility(View.VISIBLE);
                        }
                        uploadImageAdapter = new UploadImageAdapter(CreateChatMainActivity.this);
                        recyclerView_grid_chat_images.setAdapter(uploadImageAdapter);
    ...
    public class UploadImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (bitmapArrayList_uploading.size() >= 12) {
                CommonMethods.customToastMessage(getResources().getString(R.string.image_upload_limit_corss_message), CreateChatMainActivity.this);
            } else {
