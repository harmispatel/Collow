...
public class SuperRecyclerView extends FrameLayout {
    ...
    protected int ITEM_LEFT_TO_LOAD_MORE = 5;

    protected RecyclerView mRecycler;
    public static ViewStub mProgress;
    ...
    protected void initRecyclerView(View view) {
        ...
        if (!FloatUtil.compareFloats(mPadding, -1.0f)) {
            mRecycler.setPadding(0, mPadding, 0, mPadding);
        } else {
            mRecycler.setPadding(0, mPaddingTop, 0, mPaddingBottom);
        }
        mRecycler.setVerticalScrollBarEnabled(false);
        /*if (mScrollbarStyle != -1) {
            mRecycler.setScrollBarStyle(mScrollbarStyle);
            mRecycler.setScrollBarSize(0);
...
/*public void setupSwipeToDismiss(final SwipeDismissRecyclerViewTouchListener.DismissCallbacks listener) {
    ...
    public void hideMoreProgress() {
        mMoreProgress.setVisibility(View.INVISIBLE);
    }
